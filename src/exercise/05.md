...
- Style string in HTML syntax uses kebab-case whereas style object in JSX uses
  camel case, so need to mindful of how we declare these.
- className can be stringed together like `box box--small` example.
