...
- Using JSX with Javascript makes it easier to directly write HTML like
  declarative creates.
- Babel (also written is Javascript) helps to compile JSX to Javascript.
- Spread syntax {...props} (both in JSX and Javascript) is quite handy in
  merging two array of properties. It merges based on order of mentioning:
  allowing for default values to be entered on the left for certain properties.
